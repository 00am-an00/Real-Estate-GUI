...
bg_home = ImageTk.PhotoImage(file='1.png')
...
def agent_signin():
    ...
    bg_home_agent_main = ImageTk.PhotoImage(file='2.png')
    ...
    def signin():
        ...
        if username == '' or password == '':
            ...
            try:
                conn = mysql.connect(host = 'localhost', user = 'root', password = 'AmanAzeem1@',database= 'project')
                mycursor = conn.cursor()
            except mysql.Error as err:
                # messagebox.showerror('Error', 'Connection is not established! Try Again')
                print("fghjk {}".format(err))
                return
            ...
            if row == None:
                ...
                bg_home = ImageTk.PhotoImage(file='3.png')
                ...
                def Sold():
                    ...
                    global bg_home_sold
                    bg_home_sold = ImageTk.PhotoImage(file='8.png')
                ...
                def Rent():
                    ...
                    global bg_home_rent
                    bg_home_rent = ImageTk.PhotoImage(file='9.png')
                ...
                def All():
                    ...
                    global bg_home_all
                    bg_home_all= ImageTk.PhotoImage(file='10.png')
                ...
                def Available():   
                    ...
                    def sell():
                        ...
                        bg_sell = ImageTk.PhotoImage(file='6.png')
    ...
    #-------        -------------------------for navigating from sell page to match result page-------------------------------------
                        def submit_buyreq():
                            ...
                            if(street.get()!='' and city.get()!='' and bedroom.get()!='' and bathroom.get()!='' and parking.get()!='' and sellRent.get()!='' and pType.get()!=''):
                                ...
                                bg_match = ImageTk.PhotoImage(file='7.png')
...
#-----------        -------------------------------------on clicking buy button-----------------------------------
                    def buy():
                        ...
                        bg_buy = ImageTk.PhotoImage(file='5.png')
                    ...
                    bg_home = ImageTk.PhotoImage(file='4.png')
...
def office_signin():
    ...
    global Aid
    bg_home = ImageTk.PhotoImage(file='2.png')
...
#signup for officer
    def signin():
        ...
        if username == 'Aman' and passw == '1234':
            ...
            #Placing the tree in root window
            tree.place(x=70, y=140)
            
            #reading all rows in result
            count = 0
            for i in result:
                if count % 2 != 0:
            ...
            #creating entry for A_id input from user
            ...
            def agent_det():
                ...
                bg_home = ImageTk.PhotoImage(file='12.png')
                ...
                #global because A_id used in various roots 
                global Aid

                #store value of A_id in value
                value = (int(Aid.get()),)
                query = "SELECT A_id, Fname, Lname, Contact_Number, Email FROM agent where A_id = %s"
                mycursor.execute(query, value)

                #fetch output of query in result
                ...
                def sold():
                    ...
                    bg_home = ImageTk.PhotoImage(file='8.png')
                    ...
                    #creating tree view for property table
                    tree = ttk.Treeview(root8, columns=("column1", "column2", "column3", "column4", "column5","column6", "column7", "column8", "column9", "column10", "column11"), show="headings")
                    tree.column("column1", width=70, anchor="center")
                    tree.column("column2", width=110, anchor="center")
                    tree.column("column3", width=110, anchor="center")
                    ...
                    def buyer():
                        ...
                        #creating tree view for buyers table
                        tree1 = ttk.Treeview(root8, columns=("column1", "column2", "column3", "column4", "column5", "column6"), show="headings")
                        ...
                        #making tree1 table of height 2 and placing it
                        tree1.config(height=2)
                        tree1.place(x=150, y=590)

                        #getting value of P_id
                        value = (Pid.get(),)
                        ...
                        #inserting value of tree in rows
                        for row in records:
                            tree1.insert("", "end", values=row)

                    #creating entry for P_id and placing it
                ...
                def rent():
                    ...
                    bg_home = ImageTk.PhotoImage(file='9.png')
                    ...
                    def buyer():
                        ...
                        #getting value of P_id in value
                        value = (Pid.get(),)
                        ...
                        #insert values in tree1 rows
                        for row in records:
                            tree1.insert("", "end", values=row)

                    #creating entry for P_id
                ...
                def avai():
                    ...
                    root15.title('Rented Properties')
                    root15.geometry('1166x718-150-80')
                    root15.resizable(False, False)

                    bg_home_avai = ImageTk.PhotoImage(file='14.png')
                    ...
                    #creating table view for property table
                    ...
                    #making tree table of height 10 and placing it
                    ...
                    #making tree1 table of height 10 and placing it
    ...
    #creating entry for username and password
    ...
    #creating checkbutton and placing it
